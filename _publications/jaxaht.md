...
timeline_text: "Led a team of nine in releasing JaxAHT, the first open-source JAX library for ad hoc teamwork. It gives a unified pipeline for teammate generation, training, and evaluation, with substantial speedups over PyTorch implementations. Presented at the MAL-GAI workshop."
...
bibtex: |-
  @inproceedings{wang2026jaxaht,
    ...
    author = {Wang, Caroline and Fernandez, Rolando and Cui, Jiaxun and Liu, Johnny and Madhan, Aditya and Wang, Zhihan and Xiao, Lingyun and Shi, Di Yang and Rahman, Arrasy and Stone, Peter},
    year = 2026,
    month = mar
  }
code: 'https://github.com/LARG/jax-aht'
website: 'https://larg.github.io/jax-aht/'
